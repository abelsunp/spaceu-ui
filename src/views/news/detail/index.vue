<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="新闻编号" prop="newId">
        <el-input
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="新闻编号" align="center" prop="newId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="新闻编号" prop="newId">
          <el-input v-model="form.newId" placeholder="请输入新闻编号" />
        </el-form-item>
        <el-form-item label="信息" prop="info">
...
<script>
import { listDetail, getDetail, delDetail, addDetail, updateDetail, exportDetail } from "@/api/news/detail";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除新闻信息编号为"' + ids + '"的数据项?', "警告", {
